  ...
  <div>
    <div class="col-12 py-3 px-0">
      <div class="row text-right">
        <div class="col-12">
          <h5 class="text-center font-weight-bold mb-3">Assign User to Task</h5>
        </div>
        <div class="col-3"></div>
        <div class="col-9">
          <div class="row">
      ...
      <div class="collapse" id="addnew">
        <div class="card bg-transparent border-white">
          <div class="card-header bg-primary">
            <h4 class="m-0 font-weight-bold">Add new user</h4>
          </div>
          <div class="card-body">
            <div class="row my-2">
            ...
            <div class="row mt-2">
              ...
              <div class="col-9">
                <div class="row">
                  <div class="col-6">
                    <button class="btn btn-danger btn-block input-sm px-2">cancel</button>
                  </div>
                  <div class="col-6">
                    <button class="btn btn-success btn-block input-sm px-2">add</button>
                  </div>
                </div>
              </div>
            </div>
